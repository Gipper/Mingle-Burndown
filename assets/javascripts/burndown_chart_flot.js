...
// it's better to use individial data attributes from things like dates. ;)
var iterationStart = jQuery("#burndownplaceholder").data('iterationStart');
var iterationEnd =  jQuery("#burndownplaceholder").data('iterationEnd');
var actualHours = jQuery("#burndownplaceholder").data('actualHours');
var sampleRate = jQuery("#burndownplaceholder").data('sampleRate');
